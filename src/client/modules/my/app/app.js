...
export default class App extends LightningElementSLDS {
    ...
    handleEditAccount(event){
        this.template.querySelector('.backdrop').classList.add('slds-backdrop','slds-backdrop_open');
    ...
    removeModal(){
        this.template.querySelector('.backdrop').classList.remove('slds-backdrop','slds-backdrop_open');
